...
def apicall():
    ...
    if textToAnalyze == "":
        ...
        if actionSentences != []:
            suggestions = insert(actionSentences, 60, 'work')
        ...
        responses = jsonify(predictions=sequence, sentence = actionSentences[0], mindState=state, calSuggestions=suggestions, sentimentState = sentiment)
...
def updateCalender():
    textToAnalyze_json = request.get_json()
    textToAnalyze = json.loads(json.dumps(textToAnalyze_json['selection']))
    print('selection')
    ...
    for word in sentence:
        if word in work:
            isWork = True
    if isWork == True:
        schedule('Andrew', 12, 'work', '2018-06-02 11:15')
    else:
        schedule('Andrew', 12, 'other', '2018-06-02 11:15')
    #See if it's in work. 
...
# def apicall(): #We use nested functions having separate helper functions requires routing. (Will do later hopefully)
...
#         # loan_ids = test['Loan_ID']
#         textToAnalyze_json = request.get_json()
#         textToAnalyze = json.loads(textToAnalyze_json)
#         print(textToAnalyze)
...
#         print("Loading the count vectorizer...")
#         count_vect = None
#         with open('./flask_api/models/countVectorizer.pk', 'rb') as f:
#             count_vect = pickle.load(f)
#         #Load the saved model
#         print("Loading the model...")
#         loaded_model = None
#         with open('./flask_api/models/emotion_classifier.pk', 'rb') as f2:
#             loaded_model = pickle.load(f2)

#         print("The model has been loaded...doing predictions now...")
#         predictions = loaded_model.predict((count_vect.transform([textToAnalyze]))) #The model is an object that has the built-in predict method. 
...
#             print(use_neural_network("He's an idiot and a jerk."))
#             print(use_neural_network("This was the best store i've ever seen."))
#             print(use_neural_network("I am happy."))
#             print(use_neural_network("Today was a good day."))
#             print(use_neural_network("Today was a bad day."))
#             print(use_neural_network("This is bad :)"))
#             print(use_neural_network("This is good :)"))
#             print(use_neural_network("I am sad."))
#             print(use_neural_network("Happy happy happy :(."))
#             print(use_neural_network("Hello :("))
#             print(use_neural_network("Unknown :("))
#             print(use_neural_network("I convinced myself that my sadness was like a layer of skin I could never be rid of, but I realised that I’m not ready to give up just yet. There is still some fight left in me, and though the tunnel seems long and dark, there has to be the famed light at the end of it, and I want to find a way back to the light, for my parents and the people who still care for me, but most of all, for myself."))
#             print(use_neural_network("If someone were to ask me what depression feels like, I would say it feels like being 10 feet underwater with your feet tied to an anchor that’s pulling you down, down, down. You know you need to find your way back to the surface but you can’t seem to untie yourself. Will-power has reduced to nothingness."))
#             print(use_neural_network("Today started off with a bang"))
#             print(use_neural_network("Literally"))
#             print(use_neural_network("I woke up to the sound of a giant pillar falling in the construction site beside my room"))
#             print(use_neural_network("What the fuck"))
#             print(use_neural_network("These next few months living here are gonna be horrible"))
#             print(use_neural_network("It didn’t help that I only got 5 hours of sleep either, and I spilled my cereal on my shirt because of my grogginess"))
#             print(use_neural_network("At least when I got to class my best friend told me that he was going to give me $500 because he won the lottery"))
#             print(use_neural_network("Class was just the usual, and I went to the gym for the first time in 2 weeks"))
#             print(use_neural_network("As expected, my max weights dropped another 10 pounds…oops"))
#             print(use_neural_network("Anyway, I skipped the club meeting I had because I was feeling lazy, and here I am, typing this diary because I got nothing else done today"))
#             print(use_neural_network("@stellargirl I loooooooovvvvvveee my Kindle2. Not that the DX is cool, but the 2 is fantastic in its own right."))
#             print(use_neural_network("Fuck this economy. I hate aig and their non loan given asses."))
#             print(use_neural_network("Jquery is my new best friend."))
#             print(use_neural_network("how can you not love Obama? he makes jokes about himself."))
#             print(use_neural_network("@Karoli I firmly believe that Obama/Pelosi have ZERO desire to be civil.  It's a charade and a slogan, but they want to destroy conservatism"))
#             print(use_neural_network(" "))
#             print(use_neural_network(" ")) 
...
#                         'biases': tf.Variable(tf.constant(0.1, shape=[n_classes])), }
#         print('2')
#         saver = tf.train.import_meta_graph('NLP/model.ckpt.meta')
#         print('3')
...
#         """
#         print(predictions)
#         responses = jsonify(predictions=predictions[0])
#         responses.status_code = 200
